...
public class ExemplesDeMondes {
     ...
     */
    public static final ExemplesDeMondes instance = new ExemplesDeMondes();
    ...
    /**
     * Données du monde d'exemple avec des bifurcations.
     *
     * @return Fichier json au format chaine de caractères.
     */
    ...
    /**
     * Données du monde d'exemple avec des guichets et 2 sorties.
     *
     * @return Fichier json au format chaine de caractères.
     */
